...
ระบบจัดการร้านชาบูสำหรับร้านขนาดเล็ก — ลงเวลาพนักงานด้วย QR และจัดการสต๊อกสินค้า พนักงานเปิดหน้า `/clock`, เข้าสู่ระบบด้วย Google (ครั้งแรกตั้งชื่อเล่น ครั้งต่อไปจำได้เลย) แล้วบันทึกเวลาได้ทันที เบิกของที่ `/stock` ส่วน admin ดูสรุปรายวันและคลังสินค้าที่หน้า `/`.
